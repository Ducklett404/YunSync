...
ACTION_SEEDS = [
    {
        ...
        "review_status": "prototype_approved",
        "review_scope": "prototype_rules",
        "reviewer_ref": "synthetic-seed",
        "is_active": True,
        ...
        "signal_metric_codes": ["bmi", "fasting_glucose", "triglyceride"],
    ...
    },
    {
        ...
        "signal_metric_codes": ["fasting_glucose", "triglyceride"],
        "ranking_policy_version": "rank-v1",
        "explanation_policy_version": "action-explain-v1",
    },
]
