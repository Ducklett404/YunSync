...
云循正在按 V2 开发计划转向体检后的个体化食养随访。当前已实现合成报告解析、逐项确认、结构化食养安全档案、风险分流、内容审核发布，以及 M5 个体方案、7 天示例安排和采购清单的工程流程；复查迭代仍待开发。知识库种子均为候审草稿，未获专业批准前方案生成会安全阻断。旧版“候选行动—14 天个人实验”代码保留作为历史原型，已退出默认导航。
